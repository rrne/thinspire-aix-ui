...
const RightPannelComp = observer(({func, store, factory, funcTotal}:{func, store, factory, funcTotal}): JSX.Element => {
                ...
                <div className="right-box">
                    ...
                    {pannel.map((list,i) => {
                        return(
                            ...
                            <div className="factoryLabel" onClick={funcTotal}><div className="icon"><FontAwesomeIcon icon={faHouse}/></div>{list.label}</div>
                            {list.data?.map((factory,k) => {
                                ...
                                <div className={factory.electronic && factory.heats ? "factory" : "factory error"} key={k}>
                                   ...
                                   <div className="content">
                                    <div className="box" onClick={() => goToControlPage({page:"elec", value:factory.id})}>
                                    ...
                                    <div className="box" onClick={() => goToControlPage({page:"steam", value:factory.id})}>
